    ...
    var Controller = {
        ...
        lands:{
            index:function($scope, $compile,$timeout, data) {
                ...
                var options = {
                    extend: {
                        index_url: 'pokereword/index',
                        add_url: 'pokereword/add',
                        del_url: 'pokereword/del',
                        multi_url: 'pokereword/multi',
                        summation_url: 'pokereword/summation',
                        table: 'pokereword',
                    },
                    buttons : [
                        {
        ...
        viewscape:function($scope, $compile,$parse, $timeout){
            $scope.refreshRow = function(){
                $.ajax({url: "pokereword/index",dataType: 'json',
                    data:{
                        custom: {"pokereword.id":$scope.row.id}
                    },
