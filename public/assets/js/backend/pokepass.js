    ...
    var Controller = {
        ...
        lands:{
            index:function($scope, $compile,$timeout, data) {
                ...
                var options = {
                    extend: {
                        index_url: 'pokepass/index',
                        add_url: 'pokepass/add',
                        del_url: 'pokepass/del',
                        multi_url: 'pokepass/multi',
                        summation_url: 'pokepass/summation',
                        table: 'pokepass',
                    },
                    buttons : [
                        {
        ...
        viewscape:function($scope, $compile,$parse, $timeout){
            $scope.refreshRow = function(){
                $.ajax({url: "pokepass/index",dataType: 'json',
                    data:{
                        custom: {"pokepass.id":$scope.row.id}
                    },
