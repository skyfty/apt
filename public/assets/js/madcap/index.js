define(['jquery', 'bootstrap','madcap', 'easyui', 'threejs'], function ($, undefined, Madcap, undefined, THREE) {
    ...
    var Controller = {
        index: function () {
            ...
            $("#tree-level").tree({
                ...
                onClick: function(node){
                    ...
                    if (node.type === "stage" ||  node.type === "level") {
                        if (node.type === "level") {
        ...
        api: {
            ...
            getNewLevelTree:function(id, name, composition, params, stage, state) {
                return {
                    text: name,
                    id: id,
                    type: "level",
            ...
            addLevel:function(bag) {
                const composition = JSON.stringify({"cards":[]});
                ...
                Fast.api.ajax({
                    ...
                    data: {
                        ...
                        version:VERSION,
                        composition:composition,
                        params:defparams,stage:defstageparams,
                    }
                }, function (data) {
